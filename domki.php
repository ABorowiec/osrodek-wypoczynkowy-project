...
$user = $_SESSION['username'];
	...
	echo"</form>";
		...
		if (isset($_POST['dodaj']))
		{
			...
			echo "<input type='submit' name='submit' value='Dodaj rekord' />";
			echo "</form>";
		}
		if (isset($_POST['edytuj']))
		{
			...
			echo "Nazwa: <input type='text' name='nazwa' size='15' /> <br/><br/>";
			echo "Opis: <input type='text' name='opis' size='15' /> <br/><br/>";
			echo "<input type='submit' name='submit' value='Edytuj rekord' />";
			echo "</form>";
			
		}
		if (isset($_POST['usun']))
		{
			echo "<h1>Usuń z bazy</h1>";
