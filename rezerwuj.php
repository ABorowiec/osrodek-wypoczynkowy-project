...
<?php
	...
	echo "<h2 style='text-align: center; margin-top: 10px;'>Zarezerwuj domek</h2>";
			...
			$liczba_wierszy = @mysql_num_rows($do_rezezwacji);
			
			echo"<br/><br/>";
			
			echo "<br/>Wolnych domków: ".$liczba_wierszy."<br/>";
			
			//echo"<br/><br/>";
			echo"<br/><br/>";
			
		If ((!empty($do_rezezwacji)) AND ($liczba_wierszy != 0)) //jeśli zmienna $lista nie jest pusta
		{
