...
echo "<h2 id=logowanie >Rezerwuj domek</h2>";
$connection=mysql_connect ($db_host, $db_user, $db_pass) or die ("Próba połączenie z bazą danych nie powiodła się. Spróbuj ponownie");
mysql_select_db($db_name);
...
if ($liczba_wierszy > 0)
{
	...
	echo "<p class=tablefont id = rekordy >Wolnych domków: ".$liczba_w."</p>";
	//echo"<br/><br/>";
	echo"<br/><br/>";
...
' method='post' action=''>";
		...
		echo "<div>
			<p class=domkinazwaokienko id= fontloginhaslo>Imię:</p><input class=okienko id=domkiokienkotype='text' name='imie' size='15' /> </div>";
		//echo"<br/><br/>";
		echo "<div style='margin-top: 15px' >
			<p style='text-align: center; margin-left: -111px;' class=domkinazwaokienko id= fontloginhaslo>Nazwisko:</p><input class=okienko id=domkiokienko type='text' name='nazwisko' size='15' /> </div>";
		//echo"<br/><br/>";
		echo "<div style='margin-top: 15px'><p style = '    margin-left: -99px;' class=domkinazwaokienko id= fontloginhaslo>Numer:</p><input class=okienko id=domkiokienko type='text' name='telefon' size='15' /> </div>";
		//echo"<br/><br/>";
		echo "<div style='margin-top: 15px'><p style = '    margin-left: -109px' class=domkinazwaokienko id= fontloginhaslo>Ilość dni:</p><input class=okienko id=domkiokienko type='text' name='okres' size='15' /></div>";
		//echo"<br/><br/>";
		echo"<input style='margin-left: 34px;' class = zalogujbutton id = dodajdomek type='submit' name='rezerwuj' value='Rezerwuj' />";
		echo"</form>";
		echo $message;
		//echo $row[1];
		// while ($row2 = mysql_fetch_row($do_rezerwacji)) //nie działaaaaaaaaaaaaaaaaaaaaaaaaaaa
...
<div id=footer>
<center><a class=footerbutton id =domkifooter  href='index.php'>Powrót na stronę główną</a></center>
</div>
</div>
</body>
</html>